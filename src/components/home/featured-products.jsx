            ...
            return (
              <div 
                ...
                className={cn(
                  ...
                  product.status === "available" ? "hover:border-primary" : "bg-gray-50 opacity-75"
                )}
              >
                <div className={cn("h-32 rounded-lg mb-4 flex items-center justify-center", product.status === "available" ? "bg-gray-50" : "bg-gray-100")}>
                ...
                {/* line-clamp-3 limite le texte à 3 lignes pour un alignement parfait des cartes */}
                ...
                {product.status === "available" ? (
                  <>
                    <p className="text-primary font-extrabold text-lg mt-4">
                  ...
                  <>
                    <p className="text-gray-500 font-extrabold text-lg mt-4">{t("unavailable")}</p>
